pimcore.registerNS("pimcore.plugin.customJSComponent");

pimcore.plugin.customJSComponent = Class.create({
...
const customJSComponentPlugin = new pimcore.plugin.customJSComponent();
